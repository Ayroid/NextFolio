  ...
  return (
    <Container className="bg-dark py-32 md:py-24">
      ...
      >
        ...
        <Box className="absolute -left-52 top-96 z-10 h-[25rem] w-[30rem] rounded-full bg-radix-accent opacity-20 blur-[96px]"></Box>
        <Box className="absolute -right-52 top-[44rem] z-10 h-[25rem] w-[30rem] rounded-full bg-radix-accent opacity-20 blur-[96px]"></Box>
