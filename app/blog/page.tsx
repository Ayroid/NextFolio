  ...
  return (
    <Container className="bg-dark space-y-96 py-32 md:py-24">
      ...
      >
        ...
        />
        <Flex direction="column" gap="7" className="relative mt-10">
          {blogData.map((blog) => (
            <BlogCard
              key={blog.title}
              {...blog}
          ...
          <Box className="absolute -right-64 -bottom-64 h-[20rem] w-[30rem] rounded-full bg-radix-accent opacity-20 blur-[96px]"></Box>
        </Flex>
